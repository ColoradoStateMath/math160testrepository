...
On $(b,c)$, $f$ is \wordChoice{\choice[correct]{increasing} \choice{decreasing}}

On $(c,\infty)$, $f$ is \wordChoice{\choice[correct]{increasing} \choice[correct]{decreasing}}

$x=a$ is the location of a \wordChoice{\choice{Local max} \choice{Local Min} \choice[correct]{Neither}}

$x=b$ is the location of a \wordChoice{\choice{Local max} \choice[correct]{Local Min} \choice{Neither}}

$x=c$ is the location of a \wordChoice{\choice[correct]{Local max} \choice{Local Min} \choice{Neither}}
...
$x=a$ is the location of a \wordChoice{\choice{Local max} \choice[correct]{Local Min} \choice{Neither}}

$x=b$ is the location of a \wordChoice{\choice{Local max} \choice{Local Min} \choice[correct]{Neither}}

$x=c$ is the location of a \wordChoice{\choice{Local max} \choice[correct]{Local Min} \choice{Neither}}
