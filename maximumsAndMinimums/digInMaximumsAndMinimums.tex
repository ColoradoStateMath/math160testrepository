...
\item You might forget to include endpoints as critical points.  Don't forget that extrema can occur at the endpoints of a function, so you \textit{must} consider the endpoints when searching for the locations of extrema.
