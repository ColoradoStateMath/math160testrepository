...
Therefore $y$ is {\choice[correct]{smooth}\choice{not smooth}} on $[0,2\pi]$ because {\choice{$y$ is continuous} \choice[correct]{$y'$ is continuous} \choice{$y$ is not continuous} \choice{$y'$ is not continuous}} on $[0,2\pi]$.  
...
Arc Length = $\displaystyle\int_{\answer{0}}^{\answer{2\pi}} \sqrt{1+{\answer{}}^2} \ dx \approx \answer{}$ (Evaluate the arc length to 2 decimal places with technology)
...
Was your estimate for this arc length before close to the exact value?
