...
\includegraphics[scale=0.4]{CurveSketch-Ex2sp17.pdf}
...
%
%\item Sketch a graph of $f(x)$ on the grid provided.
%
%\includegraphics[scale=0.4]{2X8.pdf}

%\begin{problem}
%Describe how your graph in (b) supports the answer you found in (a).
%
%\end{problem}
