...
\begin{multipleChoice}
    ...
    \choice{No, $n=0$ and $n=1$ are not critical points because $n=0$ and $n=1$ are not in the domain of $A'(n)$.}
\end{multipleChoice}
\end{problem}
...
\begin{multipleChoice}
    ...
    \choice[correct]{$A'(n)$ is never zero, it is always positive for $n \geq 3$.}
    \choice{$A'(n)$ is never zero, it is always negative for $n \geq 3$.}
\end{multipleChoice}
\end{problem}
