...
&= (\frac{\left(\answer[given]{2} \right)^{10}}{10} -\frac{1}{\left( \answer[given]{2} \right) }) \\
&- (\frac{\left(\answer[given]{1} \right)^{10}}{10} -\frac{1}{\left( \answer[given]{1} \right)}).
\end{align*}
\end{explanation}
\end{example}
...
\begin{example}
  ...
  $\int_0^1 v(t) \ dt$.
	...
	&= \eval{\left( \answer[given]{-16t^2 + 20t} \right) }_0^1 \\
	&= 4.
      \end{align*}
